...
import FlashcardView from "@/components/study-modes/flashcards/flashcard-view";
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold">{studySet.title} - Flashcards</h1>
      </div>

      <div className="bg-gray-50 dark:bg-zinc-900 rounded-xl p-6 min-h-[70vh] flex flex-col">
        <FlashcardView studySet={studySet} />
      </div>
    </div>
  );
}
