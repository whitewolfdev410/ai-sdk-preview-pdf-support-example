...
import MatchView from "@/components/study-modes/match/match-view";
...
export default function MatchPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="bg-gray-50 dark:bg-zinc-900 rounded-xl p-4 min-h-[70vh] flex flex-col">
        <MatchView studySet={studySet} />
      </div>
    </div>
  );
}
